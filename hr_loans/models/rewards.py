...
class Contract(models.Model):
    ...
    total_rewards = integer_field('Total rewards', compute='get_count_rewards')
    ...
    total_rewards_copy = integer_field('Total rewards', related='total_rewards', readonly=True)
...
class Payroll(models.Model):
    ...
    def get_reward_next_balance(self):
        self.reward_next_balance = self.remaining_rewards - self.reward_pay_this_month - self.reward_remove_amount

    @api.one
    @api.depends('total_rewards', 'total_reward_paid')
    def get_remaining_rewards(self):
        self.remaining_rewards = self.total_rewards - self.total_reward_paid
