...
class hr_employee(models.Model):
    ...
    @api.onchange('iqama_issue_date_hijri', 'iqama_expiry_date_hijri', 'birthday_hijri', 'passport_expiry_date_hijri',
                  'passport_issue_date_hijri', 'driving_license_expiry_date_hijri','visa_expire_date_hijri','residence_expire_date_hijri','health_issue_date_hijri','health_expiry_date_hijri')
    ...
    @api.onchange('iqama_issue_date', 'iqama_expiry_date', 'birthday', 'passport_expiry_date', 'passport_issue_date','health_issue_date', 'health_expiry_date','residence_expire_date','driving_license_expiry_date')
    ...
    def name_search(self, name, args=None, operator='ilike', limit=100):
        ...
        domain = []
        if name:
            domain = ['|', '|', ('name', 'ilike', name), ('employee_english_name', 'ilike', name), ('employee_number', 'ilike', name)]
